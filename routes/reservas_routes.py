...
# POST solicita la creacion de una reserva (Alumno 6)
...
# GET /reservas/{id} devuelve el detalle de una reserva especifica


@reservas_bp.route('/<int:id>', methods=['GET'])
def obtener_reserva(id):
    return obtener_reserva_controller(id)

# PUT /reservas/{id}/estado cambia el estado respetando las transiciones


@reservas_bp.route('/<int:id>/estado', methods=['PUT'])
def actualizar_estado_reserva(id):
    return actualizar_estado_controller(id)
